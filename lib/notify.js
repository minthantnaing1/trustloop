...
function linkFor({ type, flags, txn }) {
  ...
  // Admin who is also a party: route to Admin page for BUY_SELL only
      ...
      case "BUYER_CONFIRMED":
        if (isBuyer)
          return {
            ...
            message: `You confirmed you received “${product}”. Please thank the donor and leave a review.`,
          };
        if (isSeller)
          return {
            title: "Recipient confirmed received",
            message: `Recipient confirmed he received “${product}”. You can view the summary and reviews.`,
          };
        if (isAdmin)
          return {
      ...
      case "AUTO_CONFIRMED_AFTER_3_DAYS":
        if (isBuyer)
          return {
            ...
            message: `No action for 3 days. “${product}” is automatically confirmed that recipient received the item. Please thank the donor and leave a review.`,
          };
        if (isSeller)
          return {
            title: "Order auto-confirmed",
            message: `“${product}” is automatically confirmed that recipient received the item. You can view the summary and reviews.`,
          };
        if (isAdmin)
          return {
            title: "Order auto-confirmed",
